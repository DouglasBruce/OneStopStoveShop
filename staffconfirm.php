<?php 
	...
	// insert new user
		$insertquery="insert into user (username, firstname, surname, emailadd, dob, usertype, tnc, housename, streetname, city, county, postcode, landline, mobile, salt, userpass) values (?,?,?,?,?,3,?,?,?,?,?,?,?,?,?,?);";
		...
		<div class="row">
			<div class = "col-md-6 col-md-offset-3">
				<div class="well text-center">
					<legend>Staff Created</legend>
					<p> The Staff Member can now login with their username <em><?php echo $un; ?></em></p>
					<div class="row padding-top-10">
						<a href="regstaff.php" type="submit" class="btn btn-success" value="Go to Manage Users">
							<span class="glyphicon glyphicon-menu-left"></span> Create Another Staff Member
						</a>
	...
	?>	
		...
		<div class="container">
			<div class="row">		
				...
				?>		
				<p>You need to return to the <a href = "regstaff.php">registration</a> page and try again</p>
			</div>
		</div>
	<?php 
	}
