			...
			?>	
				<div class="container">
					<div class="row">		
						...
						<p>No changes were made. Return to the <a href = 'userlist.php'>User List</a> page and try again</p>
					</div>
				</div>
			<?php 
	...
	<div class="container">
		<div class="row">
			<div class = "col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				...
				<p>User was succesfully updated</p>
	...
	<?php } else { 
		...
		<div class="container">
			<div class="row">		
				...
				?>		
				<p>You need to return to the <a href = "userlist.php">User List</a> page and try again</p>
			</div>
		</div>
	<?php 
	}
