...
if(isset($_POST['userid']) && isset($_POST['username']) && isset($_POST['firstname']) && isset($_POST['surname']) && isset($_POST['dob']) && isset($_POST['housename']) && isset($_POST['streetname']) && isset($_POST['city']) && isset($_POST['county']) && isset($_POST['postcode']) && isset($_POST['landline']) && isset($_POST['mobile']) && isset($_POST['emailadd'])) {
	$db=createConnection();
			...
			?>	
				<div class="container">
					<div class="row">		
						...
						<p>No changes were made. Return to the <a href = 'edituser.php'>Edit</a> page and try again</p>
					</div>
				</div>
			<?php 
		...
		<div class="row">
			<div class = "col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<div class="well text-center">
					...
					<p>Your Personal Details were succesfully Updated</p>
	...
	<?php } else { 
		...
		<div class="container">
			<div class="row">		
				...
				?>		
				<p>You need to return to the <a href = "edituser.php">Edit</a> page and try again</p>
			</div>
		</div>
	<?php 
	}
