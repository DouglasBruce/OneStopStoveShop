		...
		<div class="row">
			<div class = "col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<div class="well text-center">		
					<form id="listproducts" name="listproducts" method="post" action="editproducts.php" >
						<fieldset>
							<legend>Edit Product</legend>
							<label for="productid" class="control-label">Select Product to Edit: </label>
							...
							<div class="padding-top-10 text-center">
								...
								<button class="btn btn-success" type="submit">
									<span class="glyphicon glyphicon-edit"></span> Edit Product <span class="glyphicon glyphicon-menu-right"></span>
								</button>								
							</div>
						</fieldset>
					</form>
