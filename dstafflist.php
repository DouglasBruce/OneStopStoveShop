...
<body>
		...
		<div class="row">
			<div class = "col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<div class="well text-center">		
					<form id="listusers" name="listusers" method="post" action="confirmdelete.php" >
						<fieldset>
							<legend>Delete Staff</legend>
							<label for="userid" class="control-label">Select Staff to Delete: </label>
	...
	<?php
		...
		echo "<div class='container'>
			<div class='row text-center'><p>No users found!</p>
			</div>
		</div>";
	}
	?>
