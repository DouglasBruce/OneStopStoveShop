			...
			?>	
				<div class="container">
					<div class="row">		
						...
						<p>No changes were made. Return to the <a href = 'editstaffs.php'>Details</a> page and try again</p>
					</div>
				</div>
			<?php 
	...
	<?php } else { 
		...
		<div class="container">
			<div class="row">		
				...
				?>		
				<p>You need to return to the <a href = "editstaffs.php">Edit</a> page and try again</p>
			</div>
		</div>
	<?php 
	}
