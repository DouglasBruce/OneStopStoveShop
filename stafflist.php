		...
		<div class="row">
			<div class = "col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<div class="well text-center">		
					<form id="listusers" name="listusers" method="post" action="editstaff.php" >
						<fieldset>
							<legend>Edit Staff</legend>
							<label for="userid" class="control-label">Select Staff Member to Edit: </label>
							...
							<div class="padding-top-10 text-center">
								...
								<button class="btn btn-success" type="submit">
									<span class="glyphicon glyphicon-edit"></span> Edit Staff <span class="glyphicon glyphicon-menu-right"></span>
								</button>								
							</div>
						</fieldset>
					</form>				
